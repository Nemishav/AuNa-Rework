...
ParameterHandler::ParameterHandler(
  ...
  node->get_parameter(plugin_name_ + ".cost_scaling_gain",
  ...
  node->get_parameter(plugin_name_ + ".use_fixed_curvature_lookahead",
                      params_.use_fixed_curvature_lookahead);
  node->get_parameter(plugin_name_ + ".curvature_lookahead_dist",
                      params_.curvature_lookahead_dist);
  node->get_parameter(plugin_name_ + ".use_rotate_to_heading",
                      params_.use_rotate_to_heading);
  ...
  node->get_parameter(plugin_name_ + ".allow_reversing",
  ...
  node->get_parameter(plugin_name_ + ".use_collision_detection",
  ...
  dyn_params_handler_ = node->add_on_set_parameters_callback(
      std::bind(&ParameterHandler::dynamicParametersCallback, this,
                std::placeholders::_1));
}
