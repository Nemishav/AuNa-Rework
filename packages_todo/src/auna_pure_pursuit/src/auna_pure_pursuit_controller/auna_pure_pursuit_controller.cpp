...
std::unique_ptr<geometry_msgs::msg::PointStamped> AuNaPurePursuitController::createCarrotMsg(
  ...
  nav2_core::GoalChecker * goal_checker)
{
  ...
  {
    throw nav2_core::PlannerException("AuNaPurePursuitController detected collision ahead!");
  }
...
void AuNaPurePursuitController::setSpeedLimit(
